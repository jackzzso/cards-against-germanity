...
FALLBACK.blackCards = [
  "______: Die beste Entscheidung meines Lebens.",
  "In meiner Tasche finde ich plötzlich ________.",
  "Mein Geheimrezept für gute Laune: ________.",
  "Beim Familienessen reden wir nie über ________.",
  "Das nächste große Start-up heißt „________ as a Service“.",
  "Niemand hat je bereut, ________ zu googeln. Oder?",
  "Mein Browser-Verlauf besteht zu 90% aus ________.",
  "Wenn ich Präsident:in wäre, würde ich ________ verbieten.",
  "Ich habe meinen Job verloren, weil ich ________ getan habe.",
  "Der Titel meiner Biografie: „Ein Leben voller ________“.",
  "Zum ersten Date bringe ich immer ________ mit.",
  "Die Schulreform 2030 ersetzt Mathe durch ________.",
  "Im Kühlschrank steht ein Glas mit ________.",
  "Meine toxische Eigenschaft: Ich sammle ________.",
  "Netflix schlägt mir nur noch Serien über ________ vor.",
  "Auf meinem Grabstein wird stehen: „Hier ruht ________.“",
  "Die beste Ausrede für Zuspätkommen: ________.",
  "KI wird niemals ________ ersetzen.",
  "Ein deutscher Klassiker: ________, aber mit Kartoffeln.",
  "Meine Superkraft wäre ________, nur montags."
];
FALLBACK.whiteCards = [
  "ein endloser Bürokratie-Dschungel",
  "lautloser Dönerverzehr",
  "übermotivierte Elternabende",
  "Kaffee, der nach Burnout schmeckt",
  "ein 27-seitiges PDF mit falschem Anhang",
  "Datenschutz, aber nur fürs WLAN-Passwort",
  "PowerPoint mit 48 Übergängen",
  "Homeoffice in der Besenkammer",
  "eine WhatsApp-Familiengruppe um 6 Uhr morgens",
  "Smalltalk über den Wetterbericht von gestern",
  "ein Zoom-Meeting, das ein E-Mail hätte sein können",
  "vegane Bratwurst mit Persönlichkeit",
  "Steuern hinterlassen",
  "ein NFT von Omas Gartenzwerg",
  "Gratis-Storno nur gestern",
  "ein kaputter Drucker mit Attitüde",
  "Spätzle mit Existenzangst",
  "Nachbarn, die um 23:59 staubsaugen",
  "ein perfekter Kreis aus Kaffeeflecken",
  "Ironie in Comic Sans",
  "Barzahlung bei Lieferung von Ironie",
  "Energiesparen durch Kerzenlicht und Hoffnung",
  "Fitnessstudio-Mitgliedschaft als Deko",
  "ein ausgedruckter QR-Code",
  "Kartoffelsalat mit Blockchain",
  "eine To-do-Liste auf Papyrus",
  "WLAN, das nach Freiheit riecht",
  "ein Podcast über Podcasts",
  "Montag in Tabellenform",
  "ein Döner-Imbiss mit Sternemenü",
  "Schuhe aus recycelter Prokrastination",
  "eine Steuer-ID im Glückskeks",
  "Philosophieren im Aldi-Gang",
  "ein Stau aus Einkaufswagen",
  "Müsli, das passiv-aggressiv knuspert",
  "eine Bahn, die pünktlich tut",
  "Berliner Luft im Tetra Pak",
  "E-Scooter im Freibad",
  "Lautstärke auf „Schwiegermutter“",
  "ein Passwort: 1234Liebe",
  "die Kunst des Wartens in HD",
  "Jogginghose im Bundestag",
  "kostenloser Versand, 400 € Mindestbestellwert",
  "ein veganer Keks mit Fleischersatz",
  "Influencer für Fensterscheiben",
  "Kaffee IV-Drip",
  "Cloud-Speicher in der Tupperdose",
  "KI-generierte Entschuldigungen",
  "Latexhandschuhe fürs Online-Banking",
  "Coworking im Treppenhaus",
  "dreifach gefaltete Servietten der Macht"
];
